...
export default function Home() {
  return (
    <div>
      ...
      <div className=" p-10 bg-teal-600 text-white ">
        <h1 className="text-center   text-lg  md:text-4xl  ">
          I am <b>Cathleen A. Mauricette</b>, LCSW, a mental health provider who
          aims to integrate the complexity of both the human and spiritual
      ...
      <div className=" p-14 md:p-10 bg-black text-white ">
        <ul className="list-disc">
          <li className="pb-3">
            You long for more balance, peace, and joy in your relationships and
            interactions?
          </li>
          <li className="pb-3">
            You have the appearance of having it all together but sometimes find
            yourself suffering in silence?
          </li>
          <li className="pb-3">
          ...
          <li className="pb-3">
            You find that the belief systems you grew up believing are no longer
            resonating with you and don’t know where to turn to talk about it?
          </li>
        </ul>
      </div>
      ...
      <div className=" p-14 md:p-10 bg-teal-600 text-white ">
        <ul className="list-disc">
          ...
          <li className="pb-3">
            You’re ready and motivated to THRIVE and make the lifestyle changes
            necessary to do so?
          </li>
          <li className="pb-3">
            You need help creating an individualized, sustainable, and practical
            self-care routine?
          </li>
          <li className="pb-3">
      ...
      <div className="p-5 py-10 md:p-10 bg-teal-600 ">
        <h1 className="text-center   text-3xl  md:text-4xl text-white pb-10  ">
          Here’s how I can help…
        </h1>
        <p className="text-center pb-10 ">
          I treat and specialize in anxiety, depression, ADHD, bipolar, trauma,
          sexuality/gender Identity, ethically non-monogamous relationships,
          military/veteran experience, college student experience and holistic
          practices. I also offer psychiatric consultations and gender-affirming
          treatment, education and outreach as well as lifestyle coaching.
        </p>
        <p className="text-center pb-10 ">
          I partner with my clients to discover and cultivate skills for a more
          fulfilling life.
        </p>
        <p className="text-center pb-10">
